    ...
    return (
        <div className="flex flex-col items-center min-h-screen p-6">
            <div className="bg-[#fff] dark:bg-gray-700 rounded-md shadow-md w-full max-w-[1200px] px-4 py-4">
                <h1 className="text-[30px] font-bold text-center dark:text-white uppercase underline text-gray-700 pb-2">FD Investment Plan (Compound Interest)</h1>
                <div className="grid grid-cols-4 gap-4 px-3 py-3 ">
                    <div className="w-full col-span-2 p-6 mb-8">
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                className="w-full p-2 border border-gray-300 rounded-md dark:bg-gray-500 dark:text-white"
                        ...
                        <div className="items-center justify-center my-3 text-center">
                            <button
                                className="px-4 py-2 text-lg text-white transition bg-green-500 rounded-lg shadow-md hover:bg-green-600"
