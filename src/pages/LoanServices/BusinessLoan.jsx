            ...
            <div className="grid w-full grid-cols-3 gap-4 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 xs:grid-cols-1">
              <div className="items-center mb-[0px] pb-[0px] relative md:col-span-2 lg:col-span-2 sm::col-span-2 xs:col-span-2">
                ...
                <div className="px-3 pt-3 pb-8 mt-4 rounded-md shadow-md bg-slate-50 dark:bg-gray-700">
                  <h3 className="font-roboto text-[22px] dark:text-[#D6D6D6] text-green-600 font-[600] border-b-[2px]
                ...
                <div className="items-center mb-0 justify-content-end px-3 py-4 mt-[60px] text-center text-gray-600
                  ...
                  <div className="py-2 font-roboto">
                    ...
                    <p className='text-[14px] py-2'>We are here to help our customer any time. You can call on 24/7 To Answer Your Question.</p>
                  </div>
              ...
              <div className="col-span-2 bg-[#f8f8f8] dark:bg-gray-700 p-4 rounded-md shadow-md my-auto">
                <div className="flex flex-col items-start justify-center w-full ">
                  <div className="items-center justify-center w-full mb-3 text-left font-roboto text-gray-800 dark:text-[#D6D6D6]">
                    <h3 className='text-[20px] font-[700] py-1 underline uppercase'>Business Loan Overview</h3>
                    <p className='text-[15px] py-1 text-justify'>Secure your business's growth with Nofino Rural Finance Private Limited's flexible and
