...
const AboutUs = () => {
  return (
    <div>
      <section>
        <div className='flex items-center justify-center mt-[20px] w-ful '>
          <div className='max-w-[1200px] w-full items-center justify-center pl-[70px]'>
            ...
            <div className='flex w-[100%] font-roboto text-[30px] xs:text-[30px] tracking-[.9px] font-[800] mt-[-15px] dark:text-[#D6D6D6] uppercase'>
              <span>Company About US</span>
            </div>
            <div className='flex w-[100%] font-roboto text-[16px] tracking-[.45px] font-[300] dark:text-[#D6D6D6]'>
