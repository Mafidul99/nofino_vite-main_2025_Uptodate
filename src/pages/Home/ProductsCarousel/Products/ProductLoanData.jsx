...
const ProductLoanData = () => {
    const [prodGoldSlides, setProdGoldSlides] = useState([]);

    useEffect(() => {
        const fetchSlides = async () => {
            try {
                const response = await fetch('../../../api/productLoanData.json'); // Local JSON file
                const data = await response.json();
                setProdGoldSlides(data);
            } catch (error) {
...
export default ProductLoanData