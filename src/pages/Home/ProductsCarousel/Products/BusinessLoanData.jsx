...
const BusinessLoanData = () => {
    const [businessSlides, setBusinessSlides] = useState([]);

    useEffect(() => {
        const fetchSlides = async () => {
            try {
                const response = await fetch('../../../../api/businessLoanData.json'); // Local JSON file
                const data = await response.json();
                setBusinessSlides(data);
            } catch (error) {
...
export default BusinessLoanData