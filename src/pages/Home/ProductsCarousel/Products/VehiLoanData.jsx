...
const VehiLoanData = () => {
    const [veiLoanSlides, setVehiLoanSlides] = useState([]);

    useEffect(() => {
        const fetchSlides = async () => {
            try {
                const response = await fetch('../../../../api/vehiLoanData.json'); // Local JSON file
                const data = await response.json();
                setVehiLoanSlides(data);
            } catch (error) {
