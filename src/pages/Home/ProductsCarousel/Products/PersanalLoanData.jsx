...
const PersanalLoanData = () => {
    const [personalSlides, setPersonalSlides] = useState([]);

    useEffect(() => {
        const fetchSlides = async () => {
            try {
                const response = await fetch('../../../../api/personalLoanData.json'); // Local JSON file
                const data = await response.json();
                setPersonalSlides(data);
            } catch (error) {
...
export default PersanalLoanData