...
const Header = () => {
    ...
    return (
        <>
            <header className="sticky top-0 z-50 bg-[#fff] shadow-md">
                <Topbar />
                <div className='items-center w-full py-2'>
                    <div className="flex mx-auto max-w-[1200px] w-full px-4 items-center">
                        <div className='grid items-center w-full grid-cols-3 gap-1'>                        
                            <div className='items-center w-[130px] justify-start'>
                                <Link to="/">
                        ...
                        <div className='flex col-span-2 gap-3 ml-auto'>
                            <div className="flex ml-auto sm:hidden xs:hidden">
                                <Link to="/accounts" className="relative inline-flex items-center px-4 py-1.5 overflow-hidden text-lg font-medium text-gray-600 border-2 border-green-600 rounded-full outlineBtn dark:border-gray-700 hover:text-white group hover:bg-gray-50">
                                    ...
                                    <span className="relative font-roboto text-[13px] font-[700]">Open Account</span>
                                </Link>
                            </div>
                            <div className="flex ml-auto">
                                <Link to="https://nofinofinance.in/" target="_blank" className="relative inline-flex items-center justify-start py-1.5 overflow-hidden font-medium transition-all bg-green-500 dark:bg-gray-500 px-7 rounded-xl group">
                                    ...
                                    <span className="relative w-full text-left text-white transition-colors duration-200 ease-in-out group-hover:text-white font-roboto text-[13px] font-[700]">Login Page</span>
                                </Link>
                            </div>
                        </div>
                        </div>
